...
class Store extends CI_Controller {
    ...
    public function edit($id) {
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Floor not found');
            redirect(base_url().'admin/store/index');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Floor updated successfully');
                    redirect(base_url(). 'admin/store/index');
    ...
    public function delete($id){
        ...
        $this->session->set_flashdata('res_success', 'Floor deleted successfully');
        redirect(base_url().'admin/store/index');

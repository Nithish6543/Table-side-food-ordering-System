...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        ...
        <hr>
        <div class="col-12">
            <p class="lead">The easiest way to your food. Tableside Food Ordering System provides fresh delivery
                and provide free food if order is not on time. So don't wait and start ordering right now!</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <p>First thing you can do is choose a table from our restautant!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <i class="fas fa-bullseye"></i>
            <h3>Choose A Tasty Dish</h3>
            <p>We've got you covered with menus from our restaurants online!</p>
        </div>

...
<head>
    ...
    <title>Tableside Food Ordering System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"><i class="fas fa-utensil-spoon"></i> Tableside Food Ordering System</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'restaurant/index';?>">Floors</a>
                    </li>
